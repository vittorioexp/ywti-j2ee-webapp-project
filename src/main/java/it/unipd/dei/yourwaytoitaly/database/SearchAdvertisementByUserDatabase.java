...
public final class SearchAdvertisementByUserDatabase {
     ...
     *
     */
    public SearchAdvertisementByUserDatabase(final Connection con, final int reqIdCity, final int reqIdType,
                                             final Date reqDate) {
        this.con = con;
