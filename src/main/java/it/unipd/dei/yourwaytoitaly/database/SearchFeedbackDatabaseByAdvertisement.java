...
public final class SearchFeedbackDatabaseByAdvertisement {
     ...
     */
    public SearchFeedbackDatabaseByAdvertisement(final Connection con, final int reqIdAdvertisement) {
        this.con = con;
